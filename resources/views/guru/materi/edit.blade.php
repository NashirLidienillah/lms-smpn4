...
<div class="max-w-2xl mx-auto mb-20">
    ...
    <div class="bg-white rounded-3xl shadow-sm border border-gray-100">
        ...
        <form action="/guru/materi/{{ $materi->id }}" method="POST" enctype="multipart/form-data" class="p-6 md:p-8 space-y-6"
              x-data="{ currentType: '{{ $materi->tipe }}' }">
            @csrf
            @method('PUT') 
            ...
            {{-- THE STAR: DROPDOWN JENIS MATERI (Custom Alpine.js) --}}
            <div>
                ...
                <div x-data="{ 
                    ...
                    {{-- Hidden Input untuk Backend Laravel (terkoneksi dengan currentType form) --}}
