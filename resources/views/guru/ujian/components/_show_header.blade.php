...
<div class="mb-6">
    <a href="/guru/kelas/{{ $ujian->guru_mapel_id }}" class="group inline-flex items-center text-sm font-bold text-gray-400 hover:text-blue-600 transition">
...
<div class="bg-white rounded-3xl p-6 md:p-8 shadow-sm border border-gray-100 mb-8 flex flex-col lg:flex-row justify-between items-start lg:items-center relative overflow-hidden">
    ...
    <div class="relative z-10">
        <div class="flex items-center gap-3 mb-2">
            <span class="bg-blue-50 text-blue-600 text-[10px] font-black px-3 py-1 rounded-full uppercase tracking-widest border border-blue-100">Dapur Ujian CBT</span>
    ...
    <div class="mt-6 lg:mt-0 flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
        <div class="bg-slate-50 p-4 rounded-2xl border border-slate-100 flex-1">
            ...
            <div class="space-y-1.5">
                <div class="flex items-center gap-2 text-xs font-bold text-gray-700">
                    <i class="fas fa-door-open text-blue-500 w-4"></i> {{ $ujian->mulai->format('d M, H:i') }}
                </div>
                <div class="flex items-center gap-2 text-xs font-bold text-gray-700">
        ...
        <div class="bg-blue-600 p-4 rounded-2xl text-white flex flex-col justify-center items-center px-8 shadow-lg shadow-blue-100 flex-1">
