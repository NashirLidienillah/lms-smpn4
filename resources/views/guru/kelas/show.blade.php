...
{{-- ================= MENU TAB NAVIGASI (KEMBALI KE 3 TAB UTAMA) ================= --}}
...
{{-- SCRIPT: SweetAlert Delete + Logika Tabs + Modal --}}
...
<script>
    ...
    // FUNGSI TAB & FORM UI (Kembali ke 3 Tab Saja)
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Balikin fallback tab terakhir, pastikan bukan pengumuman lagi karena udah dihapus tab-nya
