    ...
    <form action="/admin/users/{{ $user->id }}" method="POST" class="p-6 md:p-8 space-y-6">
        ...
        <div>
            ...
            <div x-data="{ 
                    ...
                    options: { 'admin': 'Admin Sekolah', 'guru': 'Guru', 'siswa': 'Siswa' } 
                }" class="relative">
                ...
                <button @click="open = !open" @click.outside="open = false" type="button" 
                    ...
                    <span x-text="selected ? options[selected] : 'Pilih Peran Akun...'" :class="selected ? 'text-gray-800' : 'text-gray-400'"></span>
