...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6">
    ...
    <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex items-center gap-4">
        <div class="w-12 h-12 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center text-xl shrink-0"><i class="fas fa-list-ol"></i></div>
        <div>
    ...
    <div class="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex items-center gap-4">
        <div class="w-12 h-12 bg-blue-50 text-blue-600 rounded-2xl flex items-center justify-center text-xl shrink-0"><i class="fas fa-check-double"></i></div>
        <div>
...
<div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 md:p-10">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-10">
        ...
        <div class="flex items-start gap-3 p-4 bg-gray-50 rounded-2xl border border-gray-100">
            <i class="fas fa-wifi mt-1 text-blue-500"></i>
    ...
    <a href="/siswa/ujian/{{ $ujian->id }}/kerjakan" 
       ...
       {{ $isMengerjakan ? 'bg-amber-500 hover:bg-amber-600 shadow-amber-200' : 'bg-blue-600 hover:bg-blue-700 shadow-blue-100' }}">
