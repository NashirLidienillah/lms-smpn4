    ...
    <div class="lg:col-span-2 space-y-6">
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6 md:p-8">
            <div class="flex items-center space-x-2 text-sm text-blue-600 font-bold mb-3">
                ...
                <span>{{ $tugas->guruMapel->mapel->nama_mapel }}</span>
            </div>
            ...
            <div class="flex items-center text-sm text-gray-500 mb-6 bg-gray-50 p-3 rounded-lg border border-gray-100">
                <i class="fas fa-user-tie mr-2"></i> Oleh: {{ $tugas->guruMapel->user->name }}
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
            ...
            @if($jawaban)
                ...
                <div class="mt-4 bg-gray-50 p-4 rounded-xl border border-gray-200">
                    ...
                    <a href="{{ asset('storage/jawaban_tugas/' . $jawaban->file_jawaban) }}" target="_blank" class="text-blue-600 hover:underline text-sm break-all font-medium">
            ...
            @else
                ...
                <div class="bg-amber-50 border-l-4 border-amber-500 p-3 rounded text-sm mb-5">
                    <span class="font-bold text-amber-700">Perhatian:</span> Segera kumpulkan tugas sebelum batas waktu berakhir.
                </div>

                <form action="/siswa/tugas/{{ $tugas->id }}/submit" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                        <label class="block text-sm font-bold text-gray-700 mb-2">Upload File Jawaban <span class="text-red-500">*</span></label>
                        <input type="file" name="file_jawaban" required class="w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100 focus:outline-none transition">
                    ...
                    <div class="mb-5">
                        ...
                        <textarea name="catatan_siswa" rows="3" class="w-full border-gray-300 rounded-lg shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm" placeholder="Tulis pesan jika ada..."></textarea>
                    </div>
